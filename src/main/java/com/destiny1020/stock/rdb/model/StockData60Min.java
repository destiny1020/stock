 ...
 */
@Entity
@Table(name = "data_60min")
@NamedQueries({
    @NamedQuery(name = StockData60Min.FIND_ALL_BY_CODE, query = StockData60Min.FIND_ALL_BY_CODE_SQL),
    @NamedQuery(name = StockData60Min.FIND_MAX_DATE_BY_CODE,
        query = StockData60Min.FIND_MAX_DATE_BY_CODE_SQL)})
public class StockData60Min implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String FIND_ALL_BY_CODE = "StockData60Min.findAllByCode";
  public static final String FIND_ALL_BY_CODE_SQL =
      "SELECT s FROM StockData60Min s WHERE s.code = :code";

  public static final String FIND_MAX_DATE_BY_CODE = "StockData60Min.findMaxDateByCode";
  public static final String FIND_MAX_DATE_BY_CODE_SQL =
      "SELECT max(dateOnly) FROM StockData60Min s WHERE s.code = :code";
