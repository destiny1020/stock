...
/**
 * The persistent class for the data_daily database table.
 * 
 */
@Entity
@Table(name = "data_daily")
@NamedQueries({
    @NamedQuery(name = StockDataDaily.FIND_ALL_BY_CODE, query = StockDataDaily.FIND_ALL_BY_CODE_SQL),
    @NamedQuery(name = StockDataDaily.FIND_MAX_DATE_BY_CODE,
        query = StockDataDaily.FIND_MAX_DATE_BY_CODE_SQL)})
public class StockDataDaily implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String FIND_ALL_BY_CODE = "StockDataDaily.findAllByCode";
  public static final String FIND_ALL_BY_CODE_SQL =
      "SELECT s FROM StockDataDaily s WHERE s.code = :code";

  public static final String FIND_MAX_DATE_BY_CODE = "StockDataDaily.findMaxDateByCode";
  public static final String FIND_MAX_DATE_BY_CODE_SQL =
      "SELECT max(date) FROM StockDataDaily s WHERE s.code = :code";
  ...
  public Double getMa888() {
    return this.ma888;
  }

  public void setMa888(Double ma888) {
    this.ma888 = ma888;
  }
  ...
  public Double getMax888() {
    return this.max888;
  }

  public void setMax888(Double max888) {
    this.max888 = max888;
  }
  ...
  public Double getMin888() {
    return this.min888;
  }

  public void setMin888(Double min888) {
    this.min888 = min888;
  }
