...
@NamedQueries({
    @NamedQuery(name = StockData30Min.FIND_ALL_BY_CODE, query = StockData30Min.FIND_ALL_BY_CODE_SQL),
    @NamedQuery(name = StockData30Min.FIND_MAX_DATE_BY_CODE,
        query = StockData30Min.FIND_MAX_DATE_BY_CODE_SQL)})
public class StockData30Min implements Serializable {
  private static final long serialVersionUID = 1L;

  public static final String FIND_ALL_BY_CODE = "StockData30Min.findAllByCode";
  public static final String FIND_ALL_BY_CODE_SQL =
      "SELECT s FROM StockData30Min s WHERE s.code = :code";

  public static final String FIND_MAX_DATE_BY_CODE = "StockData30Min.findMaxDateByCode";
  public static final String FIND_MAX_DATE_BY_CODE_SQL =
      "SELECT max(dateOnly) FROM StockData30Min s WHERE s.code = :code";
